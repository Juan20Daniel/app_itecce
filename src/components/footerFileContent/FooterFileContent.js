...
const FooterFileContent = ({uploadedFile, nameExcel, inserts, updates, faileds, downloadExcel,section, loadFile, close, isLoading}) => (
        ...
        <div className='box-btns'>
            {!uploadedFile ? 
                ...
                <>
                    ...
                    <Link className='footer-btn' to='/'>Generar credenciales</Link>
                </>
            }
        </div>
    </div>
